...
class SociosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create socio" do
    assert_difference("Socio.count") do
      post socios_url, params: { socio: { apellido: @socio.apellido, ciudad: @socio.ciudad, direccion: @socio.direccion, nombre: @socio.nombre, rut: @socio.rut, telefono: @socio.telefono } }
    end
  ...
  test "should update socio" do
    patch socio_url(@socio), params: { socio: { apellido: @socio.apellido, ciudad: @socio.ciudad, direccion: @socio.direccion, nombre: @socio.nombre, rut: @socio.rut, telefono: @socio.telefono } }
